...
//  VidEdit Magic
//
//  Created by Unique Consulting Firm on 09/05/2024.
//
...
class VideoEditorViewController: UIViewController {
    ...
    @IBOutlet weak var saveHideView: UIView!
    @IBOutlet weak var collectnvw_Menu: UICollectionView!
        ...
        // Array Declartion
        var menuItems = ["_filterpng","_trim","music_icon","_speed","_text_icon","sticker", "_multiple_", "transition-"]
        ...
        override func viewDidLoad() {
            ...
            self.setTitle("Marvel Editor", andImage: UIImage(named: "2")!)
            ...
            NotificationCenter.default.addObserver(self, selector: #selector(VideoEditorViewController.keyboardWillShow), name: UIResponder.keyboardWillShowNotification, object: nil)
            NotificationCenter.default.addObserver(self, selector: #selector(VideoEditorViewController.keyboardWillHide), name: UIResponder.keyboardWillHideNotification, object: nil)
...
//                                        self.navigationItem.rightBarButtonItem  = saveBarBtnItm
                                        self.showAlert(title: "Done", message: "Edit Video is Saved")
            ...
            if isMergeClicked == true {
                ...
                if assetArray.count > 0 {
                    ...
                    OptiVideoEditor().mergeTwoVideosArry(arrayVideos: assetArray, success: { (url) in
                        DispatchQueue.main.async {
                            self.saveHideView.isHidden = false
...
//                                        self.navigationItem.rightBarButtonItem  = saveBarBtnItm
    ...
    extension VideoEditorViewController : UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIViewControllerTransitioningDelegate {
    ...
    extension VideoEditorViewController : UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            case 4:
                let cell: CollectionViewMenuCell = collectionView.dequeueReusableCell(withReuseIdentifier: OptiConstant().CMenuCell, for: indexPath) as! CollectionViewMenuCell
                if strSelectedSticker == "stickes\(indexPath.row + 1)" {
                ...
                cell.imgvw_Menu.image = UIImage(named:"stickes\(indexPath.row + 1)")
                return cell
            case 5:
                let cell: SpeedCollectionCell = collectionView.dequeueReusableCell(withReuseIdentifier: OptiConstant().CSpeedCell, for: indexPath) as! SpeedCollectionCell
    ...
    extension VideoEditorViewController : UICollectionViewDelegate {
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
            ...
            if self.progressvw_back.isHidden == true {
                ...
                case 1:
                    ...
                    case 0:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add filter")
                               // OptiToast.showPositiveMessage(message: OptiConstant().slctvideofilter)
                            }
                        }
                    case 1:
                        // crop Video
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add crop")
                    ...
                    case 2:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to merge the audio")
                    ...
                    case 3:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add speed animation")
                    ...
                    case 4:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add text inside video")
                    ...
                    case 5:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add sticker inside video")
                    ...
                    case 7:
                        ...
                        if (self.slctVideoUrl != nil) {
                            ...
                            DispatchQueue.main.async {
                                self.showAlert(title: "Error", message: "Select the video which you want to add transition animation")
                ...
                DispatchQueue.main.async {
                    self.showAlert(title: "Error", message: "Another video editor action is processing so it can't be process new action, please wait")
    ...
    extension VideoEditorViewController: MPMediaPickerControllerDelegate {
    ...
    extension VideoEditorViewController : OptiRangeSliderViewDelegate {
